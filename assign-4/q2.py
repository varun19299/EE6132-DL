...
# Args
parser = argparse.ArgumentParser(description='Q1 Tutorial 4')
...
hidden_ll = [64,128,256,512]

for hidden_size in hidden_ll:
    print(f"Hidden Size {hidden_size}")
    do_autoencoder(train_loader, hidden_size = hidden_size, device = args.device, learning_rate = LR, num_epochs = EPOCHS )
