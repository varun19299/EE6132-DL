...
# Args
parser = argparse.ArgumentParser(description='q6 Tutorial 4')
...
make_dirs("logs/q6")
make_dirs("checkpoints/q6")

noise = 0.3

do_autoencoder(train_loader, noise = noise, device = args.device, learning_rate = LR, num_epochs = EPOCHS )
