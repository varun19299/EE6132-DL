...
sparsity_ll = [0.001,0.01,0.1,0.5]

for sparsity in sparsity_ll:
    print(f"Sparsity {sparsity}")
    do_autoencoder(train_loader, sparsity = sparsity, device = args.device, learning_rate = LR, num_epochs = EPOCHS )
